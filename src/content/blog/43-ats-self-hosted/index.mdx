...
description: "When the contract ended, I built the tool I needed to beat the ATS and tailor my resume to every job description."
date: "06/27/2026"
...
I began with a Streamlit app that compared a resume to multiple job descriptions using sentence embeddings and some natural language processing. It ran, and it produced numbers, but the numbers did not mean much. The first thing I did was the unglamorous thing: I read the whole thing line by line to confirm it was not doing anything malicious or sending my resume anywhere. It was clean, fully local, which mattered because everything about this needed to stay on my own hardware.
...
One detail worth mentioning, since it affects the vocabulary directly. The Department of Defense is in the middle of being renamed the Department of War. The executive order is in place and the term is in active use, but the legal change is still working through Congress. Real job descriptions right now use both names. The tool treats "Department of War," "Department of Defense," "DoW," and "DoD" as one and the same, so a posting scores the same either way and my resume matches whichever form I wrote. It absorbs the naming churn without me having to think about it.
