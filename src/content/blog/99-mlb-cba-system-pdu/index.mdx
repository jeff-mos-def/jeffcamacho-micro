...
PMBOK 8's Governance performance domain is relevant here. Governance isn't just about oversight. It's about designing the structures, policies, and decision frameworks that shape how people behave on your project. When governance is poorly designed, you get rational actors making irrational-looking decisions. The Cubs' front office wasn't failing at governance. The league's governance was failing them by making the wrong choice the smart one.

![The Perverse Incentive Loop](/img/perverse-incentive-loop.svg)

---

**2. The Draft Lottery: Governance That Makes Losing Unprofitable**
...
**3. The Pre-Arbitration Bonus Pool: Paying for What You Actually Want**
...
The 2022 CBA created a $50 million pre-arbitration bonus pool. The money gets distributed to the top 100 young players based on statistical performance. It's not a huge sum split across 100 players, but that's not the point. The point is that the system now has a mechanism that connects performance to reward before arbitration kicks in.
...
**4. The Joint Competition Committee: Change Governance That Actually Ships**

One of the most overlooked provisions in the 2022 CBA is the Joint Competition Committee. It's made up of four active players, six members appointed by MLB, and one umpire. This committee has the authority to adopt rule changes, like the pitch clock, the shift ban, and larger bases, over a single offseason.

Before this committee existed, MLB could unilaterally implement rule changes but had to wait at least a year after notifying the union. That process was slow, adversarial, and designed to protect the status quo. The committee replaced it with a standing body that has cross-functional representation and the authority to act within 45 days of approval.

PMBOK 7 had a principle called Tailoring: the idea that processes should be adapted to fit the project context. PMBOK 8 takes this further with its five Focus Areas, which are explicitly designed to be "development-approach agnostic," applicable across predictive, adaptive, and hybrid environments. The Joint Competition Committee embodies this. It's a governance structure built for speed and adaptability, not for one specific way of doing things.

If you've ever tried to get a process change approved through three layers of steering committees and a quarterly governance board, you understand why this matters. The old MLB model is the same model most enterprises use for change management: propose, wait, debate, escalate, wait more, maybe implement next fiscal year. The new model puts the right people in a room with decision-making authority and a short timeline.
...
**5. The Luxury Tax Tiers: Graduated Consequences Beat Binary Penalties**

The CBA's competitive balance tax is structured in four tiers. The first threshold in 2022 was $230 million. Exceed it, and you pay a percentage surcharge. But the surcharges escalate at $250 million, $270 million, and $290 million, with each tier carrying steeper penalties and additional consequences like draft pick forfeiture.
...
PMBOK 8's Finance performance domain (which replaces the old Cost Management knowledge area) aligns with this thinking. Finance isn't just about tracking spend against a baseline. It's about understanding the financial implications of decisions and making tradeoffs visible. The luxury tax model does exactly that. It makes the cost of every incremental dollar transparent and lets decision-makers choose their risk level with full information.
